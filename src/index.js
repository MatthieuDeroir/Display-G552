            ...
            if (data.Mode === 9) {
                ...
                switch (data.Mode) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        mediaArray = [{order: 1, path: 'staticMedias/English/_MAKE_SOME_NOISE.mp4', duration: 3, type: 'video'}];
                        break;
                    case 10:
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        mediaArray = [{order: 1, path: 'staticMedias/English/_TIMEOUT.mp4', duration: 3, type: 'video'}];
                        break;
                    case 14:
